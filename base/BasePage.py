...
class BaseClass:
    ...
    def getWebElement(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info("WebElement found with locator value " + locatorValue +
                          " using locatorType " + locatorByType)
        except:
            self.log.error(
    ...
    def clickOnElement(self, locatorValue, locatorType="id"):
        try:
            ...
            self.log.error(
                "Unable to Click on WebElement with locator value " + locatorValue +
    ...
    def enterText(self, text, locatorValue, locatorType="id"):
        try:
            ...
            self.log.info(
                "Entered the text " + text + " in WebElement with locator value " + locatorValue +
                " using locatorType " + locatorType)
        except:
            self.log.error(
                "Unable to enter the text " + text + " in WebElement with locator value " + locatorValue +
                "using locatorType " + locatorType)
            print_stack()
            self.takeScreenshot(locatorType)
            assert False
    ...
    def getText(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info(
                "Got the text " + elementText + " from WebElement with locator value " + locatorValue +
                " using locatorType " + locatorType)
        except:
            self.log.error(
    ...
    def isElementDisplayed(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.info(
                "WebElement is Displayed on web page with locator value " + locatorValue +
                " using locatorType " + locatorType)
        except:
            self.log.error(
    ...
    def scrollTo(self, locatorValue, locatorType="id"):
        ...
        try:
            ...
            self.log.error(
                "Unable to scroll to WebElement with locator value " + locatorValue +
                "using locatorType " + locatorType)
            print_stack()
    ...
    def sendText(self, text, locatorValue, locatorType="id"):
        try:
            ...
            self.log.info(
                "Sent the text " + text + " in WebElement with locator value " + locatorValue +
                " using locatorType " + locatorType)
        except:
            self.log.error(
                "Unable to Send the text " + text + " in WebElement with locator value " + locatorValue +
                "using locatorType " + locatorType)
            print_stack()
    ...
    def windowhandling(self):
        try:
            ...
            self.log.info("New window was closed, now back to original window")
        except:
            self.log.error("Unable to perform action on window")
